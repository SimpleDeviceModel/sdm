...
In order to use code from the SDM plugin, loading it dynamically is not really necessary -- you can just link the plugin code as a static or shared library. If the plugin was created with the \shellcmd{pluginprovider} library, you can even skip the C-style SDM API altogether and access the plugin classes directly.
