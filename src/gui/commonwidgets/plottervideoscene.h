 ...
 *
 * This header file defines a class that can display moving 2D pictures.
 */

#ifndef PLOTTERVIDEOSCENE_H_INCLUDED
#define PLOTTERVIDEOSCENE_H_INCLUDED
...
class PlotterVideoScene : public PlotterAbstractScene {
	Q_OBJECT
	
	QVector<qreal> _buffer;
...
public:
	...
	virtual bool zeroIsTop() const override;
